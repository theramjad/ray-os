...
53. **Use `/copy` to make it easier to share results** — good for drafting emails or messages. Copies Claude's last response to clipboard so you can paste it directly into Slack, email, or wherever you need it.
